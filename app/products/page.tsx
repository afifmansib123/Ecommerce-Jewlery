    ...
    return (
      <div className="min-h-screen relative">
        <div className="fixed inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-stone-900/85 via-stone-800/80 to-stone-900/90"></div>
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 -mt-8 relative z-10">
          <motion.div 
            className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-8 mb-8"
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-6">
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-12 h-12 bg-white/20 border-white/30 text-white placeholder-stone-300 focus:ring-2 focus:ring-white/50 focus:border-white/50 rounded-xl transition-all duration-300 backdrop-blur-sm"
                />
              </div>
          ...
          {filteredProducts.length === 0 && !loading && (
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg p-12 max-w-md mx-auto border border-stone-200">
                ...
                <h3 className="text-xl font-semibold text-stone-900 mb-4">No Results Found</h3>
