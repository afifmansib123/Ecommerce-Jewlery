...
const AdminProducts: React.FC = () => {
  ...
  const handleDeleteProduct = async (productId: string) => {
    if (
      !confirm(
        "Are you sure you want to delete this antique piece? This action cannot be undone."
      )
    ) {
      return;
    }
  ...
  const actions = (
    <div className="flex space-x-2">
      <Button
        asChild
        className="bg-stone-800 hover:bg-stone-900 text-white shadow-md"
      >
        <Link
      ...
      >
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <div className="animate-spin rounded-full h-16 w-16 border-4 border-stone-300 border-t-stone-600 mx-auto"></div>
  ...
  return (
    ...
    >
      ...
      <Card className="mb-6 border-stone-200 bg-gradient-to-r from-white to-stone-50">
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="active-filter" className="text-sm text-amber-800">
                Active Only
              </Label>
            </div>
            <div className="flex items-center space-x-2">
          ...
          {products.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-medium text-amber-900 mb-2">
                {totalCount === 0
                  ? "No Antiques in Collection"
                  : "No matching pieces found"}
              </h3>
              <p className="text-amber-700 mb-6">
                {totalCount === 0
                  ? "Begin building your precious collection"
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-stone-50/50">
                      <TableHead className="text-stone-900">
                        Antique Piece
                      </TableHead>
                      <TableHead className="text-stone-900">Category</TableHead>
                      <TableHead className="text-stone-900">SKU</TableHead>
                      <TableHead className="text-stone-900">Price</TableHead>
                      <TableHead className="text-stone-900">
                        Condition
                      </TableHead>
                      <TableHead className="text-stone-900">Stock</TableHead>
                      <TableHead className="text-stone-900">Status</TableHead>
                      <TableHead className="text-right text-amber-900">
                        Actions
                      </TableHead>
                    </TableRow>
                  </TableHeader>
