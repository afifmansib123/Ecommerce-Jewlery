...
const translations = {
  en: {
    ...
    "home.featured.subtitle":
      "Discover our most coveted antique jewelry pieces",
    ...
    "footer.crafted":
      "Crafted with passion for antique jewelry & collectible enthusiasts",

    "about.hero.established": "Established 2008 • Bangkok, Thailand",
    "about.hero.gallery": "Wangmanee",
    "about.hero.title": "Gallery",
    "about.hero.subtitle":
    ...
    "about.stats.pieces": "Authenticated Pieces",
    "about.stats.collectors": "Satisfied Collectors",
    "about.stats.authenticity": "Authenticity Rate",

    "about.heritage.label": "Our Heritage",
    "about.heritage.title": "A Legacy of",
    "about.heritage.authenticity": "Authenticity",
    "about.heritage.paragraph1":
      "Founded in 2008 by master jeweler Somchai Wangmanee, our gallery represents three generations of expertise in fine antique jewelry. Located in the heart of Bangkok's historic district, we have built our reputation on meticulous authentication and uncompromising quality.",
    "about.heritage.paragraph2":
      "What began as a passion for preserving historical craftsmanship has evolved into Southeast Asia's most trusted source for authenticated antique jewelry. Each piece in our collection undergoes rigorous verification, complete with detailed provenance documentation.",
    "about.heritage.paragraph3":
      "Today, collectors from around the world trust Wangmanee Gallery to provide not just exquisite jewelry, but the stories and heritage that make each piece truly exceptional. Our commitment to authenticity remains unwavering after more than a decade of service.",
    "about.heritage.imageAlt": "Antique jewelry workshop",
    "about.heritage.established": "Est. 2008",
    "about.heritage.location": "Bangkok, Thailand",

    "about.expertise.label": "Our Expertise",
    "about.expertise.title": "Uncompromising",
    "about.expertise.standards": "Standards",
    "about.expertise.subtitle":
      "Every piece meets our exacting standards for authenticity, condition, and historical significance",

    "about.expertise.authentication.title": "Expert Authentication",
    "about.expertise.authentication.description":
      "Our certified gemologists and historians verify every piece using advanced techniques and decades of expertise to ensure absolute authenticity.",

    "about.expertise.collection.title": "Curated Collection",
    "about.expertise.collection.description":
      "Each piece is carefully selected for its historical significance, craftsmanship quality, and provenance documentation before joining our collection.",

    "about.expertise.guarantee.title": "Lifetime Guarantee",
    "about.expertise.guarantee.description":
      "We stand behind every piece with comprehensive documentation and a lifetime authenticity guarantee for complete peace of mind.",

    "about.team.label": "Meet Our Experts",
    "about.team.title": "The",
    "about.team.specialists": "Specialists",
    "about.team.behind": "Behind Your Collection",
    "about.team.subtitle":
      "Our team combines generations of experience with modern authentication techniques",

    "about.team.founder.role": "Founder & Master Appraiser",
    "about.team.founder.description":
      "Third-generation jewelry expert with 25+ years specializing in Victorian and Art Deco pieces",

    "about.team.authenticator.role": "Senior Authenticator",
    "about.team.authenticator.description":
      "Ph.D. in Art History, specialist in Asian antiques and provenance documentation",

    "about.team.curator.role": "European Antiques Curator",
    "about.team.curator.description":
      "Former Sotheby's specialist with expertise in European estate jewelry",

    "about.visit.label": "Visit Our Gallery",
    "about.visit.title": "Ready to Discover Your",
    "about.visit.perfect": "Perfect Piece",
    "about.visit.subtitle":
      "Experience our collection in person or browse our authenticated pieces online with detailed provenance",
    "about.visit.browse": "Browse Collection",
    "about.visit.visit": "Visit Gallery",
    "about.visit.address": "Wangmanee Jewelry Store, Bangkok, Thailand",
    "about.visit.hours": "Open Daily: 10:00 AM - 8:00 PM",
    "about.visit.appointments": "Private appointments available",

    "admin.quickActions.viewAllProducts": "View All Products",
    "admin.quickActions.viewAllProductsDesc": "Browse all jewelry pieces",
    "admin.quickActions.viewAllCategories": "View All Categories",
    "admin.quickActions.viewAllCategoriesDesc": "Manage all categories",
  },
  th: {
    // Navigation
    "nav.home": "หน้าแรก",
    ...
    "home.features.expertGuidesDesc":
      "ผู้เชี่ยวชาญที่ได้รับการรับรองของเราตรวจสอบทุกชิ้นพร้อมเอกสารที่มาโดยละเอียด",
    "home.features.premiumQuality": "คุณภาพพรีเมียม",
    "home.features.premiumQualityDesc":
      "คอลเลกชันที่คัดสรรอย่างพิถีพิถันของเครื่องประดับโบราณแท้พร้อมการตรวจสอบความแท้",
    "home.features.uniqueDestinations": "คอลเลกชันที่เป็นเอกลักษณ์",
    "home.features.uniqueDestinationsDesc":
      "จากความหรูหราแบบวิคตอเรียถึงผลงานชิ้นเอกอาร์ตเดโค เคลือบจีนถึงของโบราณยุโรป",
    ...
    "cart.empty.subtitle":
      "ค้นพบเครื่องประดับโบราณที่งดงามและเพิ่มลงในตะกร้าของคุณ",
    ...
    "auth.signup.passwordRequirements":
      "ต้องมีอย่างน้อย 8 ตัวอักษร ประกอบด้วยตัวพิมพ์ใหญ่ พิมพ์เล็ก และตัวเลข",
    ...
    "tourDetail.securePayments":
      "การชำระเงินปลอดภัยและการตรวจสอบจากผู้เชี่ยวชาญ",
    ...
    "about.hero.established": "ก่อตั้งปี 2008 • กรุงเทพฯ ประเทศไทย",
    "about.hero.gallery": "วังมณี",
    "about.hero.title": "แกลเลอรี",
    "about.hero.subtitle":
      "คัดสรรเครื่องประดับโบราณพิเศษพร้อมการตรวจสอบที่มาสำหรับนักสะสมที่เลือกสรรทั่วโลก",

    "about.stats.years": "ปีแห่งความเชี่ยวชาญ",
    "about.stats.pieces": "ชิ้นที่ตรวจสอบแล้ว",
    "about.stats.collectors": "นักสะสมที่พอใจ",
    "about.stats.authenticity": "อัตราความแท้",

    "about.heritage.label": "มรดกของเรา",
    "about.heritage.title": "มรดกแห่ง",
    "about.heritage.authenticity": "ความแท้",
    "about.heritage.paragraph1":
      "ก่อตั้งในปี 2008 โดยช่างเครื่องประดับเซียน สมชาย วังมณี แกลเลอรีของเราเป็นตัวแทนของความเชี่ยวชาญสามชั่วอายุคนในเครื่องประดับโบราณชั้นดี ตั้งอยู่ในใจกลางย่านประวัติศาสตร์ของกรุงเทพฯ เราได้สร้างชื่อเสียงจากการตรวจสอบที่พิถีพิถันและคุณภาพที่ไม่ยอมประนีประนอม",
    "about.heritage.paragraph2":
      "สิ่งที่เริ่มต้นจากความหลงใหลในการอนุรักษ์งานฝีมือทางประวัติศาสตร์ได้พัฒนาเป็นแหล่งที่เชื่อถือได้มากที่สุดในเอเชียตะวันออกเฉียงใต้สำหรับเครื่องประดับโบราณที่ตรวจสอบแล้ว ชิ้นแต่ละชิ้นในคอลเลกชันของเราได้รับการตรวจสอบอย่างเข้มงวด พร้อมด้วยเอกสารที่มาโดยละเอียด",
    "about.heritage.paragraph3":
      "ปัจจุบัน นักสะสมจากทั่วโลกไว้วางใจ วังมณีแกลเลอรี ในการมอบไม่เพียงแค่เครื่องประดับที่งดงาม แต่ยังรวมถึงเรื่องราวและมรดกที่ทำให้แต่ละชิ้นมีความพิเศษอย่างแท้จริง ความมุ่งมั่นของเราต่อความแท้ยังคงแน่วแน่หลังจากให้บริการมากว่าทศวรรษ",
    "about.heritage.imageAlt": "โรงงานเครื่องประดับโบราณ",
    "about.heritage.established": "ก่อตั้ง 2008",
    "about.heritage.location": "กรุงเทพฯ ประเทศไทย",

    "about.expertise.label": "ความเชี่ยวชาญของเรา",
    "about.expertise.title": "มาตรฐานที่",
    "about.expertise.standards": "ไม่ยอมประนีประนอม",
    "about.expertise.subtitle":
      "ทุกชิ้นต้องผ่านมาตรฐานเข้มงวดของเราด้านความแท้ สภาพ และความสำคัญทางประวัติศาสตร์",

    "about.expertise.authentication.title": "การตรวจสอบจากผู้เชี่ยวชาญ",
    "about.expertise.authentication.description":
      "นักอัญมณีศาสตร์และนักประวัติศาสตร์ที่ได้รับการรับรองของเราตรวจสอบทุกชิ้นโดยใช้เทคนิคขั้นสูงและความเชี่ยวชาญหลายทศวรรษเพื่อให้แน่ใจถึงความแท้อย่างสมบูรณ์",

    "about.expertise.collection.title": "คอลเลกชันที่คัดสรร",
    "about.expertise.collection.description":
      "แต่ละชิ้นได้รับการคัดเลือกอย่างพิถีพิถันด้านความสำคัญทางประวัติศาสตร์ คุณภาพงานฝีมือ และเอกสารที่มาก่อนเข้าร่วมคอลเลกชันของเรา",

    "about.expertise.guarantee.title": "การรับประกันตลอดชีวิต",
    "about.expertise.guarantee.description":
      "เราสนับสนุนทุกชิ้นด้วยเอกสารครบถ้วนและการรับประกันความแท้ตลอดชีวิตเพื่อความอุ่นใจอย่างสมบูรณ์",

    "about.team.label": "พบกับผู้เชี่ยวชาญของเรา",
    "about.team.title": "",
    "about.team.specialists": "ผู้เชี่ยวชาญ",
    "about.team.behind": "เบื้องหลังคอลเลกชันของคุณ",
    "about.team.subtitle":
      "ทีมของเราผสมผสานประสบการณ์หลายชั่วอายุคนกับเทคนิคการตรวจสอบสมัยใหม่",

    "about.team.founder.role": "ผู้ก่อตั้งและผู้ประเมินเซียน",
    "about.team.founder.description":
      "ผู้เชี่ยวชาญเครื่องประดับชั่วอายุคนที่สามด้วยประสบการณ์ 25+ ปี เชี่ยวชาญด้านชิ้นวิคตอเรียและอาร์ตเดโค",

    "about.team.authenticator.role": "ผู้ตรวจสอบอาวุโส",
    "about.team.authenticator.description":
      "ปริญญาเอกด้านประวัติศาสตร์ศิลปะ ผู้เชี่ยวชาญด้านโบราณเอเชียและเอกสารที่มา",

    "about.team.curator.role": "ผู้ดูแลโบราณยุโรป",
    "about.team.curator.description":
      "อดีตผู้เชี่ยวชาญของ Sotheby's ด้วยความเชี่ยวชาญในเครื่องประดับมรดกยุโรป",

    "about.visit.label": "เยี่ยมชมแกลเลอรีของเรา",
    "about.visit.title": "พร้อมที่จะค้นพบ",
    "about.visit.perfect": "ชิ้นที่สมบูรณ์แบบ",
    "about.visit.subtitle":
      "สัมผัสคอลเลกชันของเราด้วยตัวเองหรือเรียกดูชิ้นที่ตรวจสอบแล้วออนไลน์พร้อมที่มาโดยละเอียด",
    "about.visit.browse": "เรียกดูคอลเลกชัน",
    "about.visit.visit": "เยี่ยมชมแกลเลอรี",
    "about.visit.address": "ร้านเครื่องประดับวังมณี กรุงเทพฯ ประเทศไทย",
    "about.visit.hours": "เปิดทุกวัน: 10:00-20:00 น.",
    "about.visit.appointments": "มีการนัดหมายส่วนตัว",

    // Admin Quick Actions (Thai)
    ...
    "admin.quickActions.viewAllProducts": "ดูสินค้าทั้งหมด",
    "admin.quickActions.viewAllProductsDesc": "เรียกดูเครื่องประดับทั้งหมด",
    "admin.quickActions.viewAllCategories": "ดูหมวดหมู่ทั้งหมด",
    "admin.quickActions.viewAllCategoriesDesc": "จัดการหมวดหมู่ทั้งหมด",
  },
};
